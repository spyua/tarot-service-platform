      ...
      <AnimatedContainer>
        <div className="space-y-12">
              ...
              <div className="space-y-4">
                <div>
                  <h1 className="heading-1">
                    主標題 (H1) - Noto Serif TC
                  </h1>
                </div>
                <div>
                  <h2 className="heading-2">
                    副標題 (H2) - Noto Serif TC
                  </h2>
                </div>
                <div>
                  <h3 className="heading-3">
                    小標題 (H3) - Noto Serif TC
                  </h3>
                </div>
                <div>
                  <p className="body-large">
                    大型內文 - Inter 字體，適合重要段落。
                  </p>
                </div>
                <div>
                  <p className="body">
                    標準內文 - Inter 字體，適合長篇閱讀的現代無襯線字體。
                  </p>
                </div>
                <div>
                  <p className="body-small">
                    小型內文 - Inter 字體，用於輔助說明。
                  </p>
                </div>
                <div>
                  <p className="caption">
                    註腳文字 - Inter 字體，用於最小的文字元素。
                  </p>
                </div>
                <div>
          ...
          <section className="section">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-medium font-primary mb-3">按鈕變體</h3>
              ...
              <div>
                <h3 className="text-lg font-medium font-primary mb-3">按鈕尺寸</h3>
              ...
              <div>
                <h3 className="text-lg font-medium font-primary mb-3">按鈕狀態</h3>
                <div className="flex flex-wrap gap-4">
                  <Button variant="primary" loading={loading} onClick={handleLoadingTest}>
                    {loading ? '載入中...' : '測試載入'}
                  </Button>
                  <Button variant="primary" disabled>停用按鈕</Button>
                  <Button variant="primary" fullWidth className="max-w-xs">全寬按鈕</Button>
                </div>
              </div>
            </div>
          </section>
          ...
          {/* Container */}
          <section className="section">
            <h2 className="text-2xl font-semibold font-primary mb-6">容器組件</h2>
            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-medium font-primary mb-3">不同尺寸的容器</h3>
                <div className="space-y-4">
                  <div className="border border-dashed border-gray-300 p-2">
                    <Container size="sm" className="bg-primary-100 p-4 text-center">
                      <p>小型容器 (sm)</p>
                    </Container>
                  </div>
                  <div className="border border-dashed border-gray-300 p-2">
                    <Container size="md" className="bg-primary-100 p-4 text-center">
                      <p>中型容器 (md)</p>
                    </Container>
                  </div>
                  <div className="border border-dashed border-gray-300 p-2">
                    <Container size="lg" className="bg-primary-100 p-4 text-center">
                      <p>大型容器 (lg)</p>
                    </Container>
                  </div>
                </div>
